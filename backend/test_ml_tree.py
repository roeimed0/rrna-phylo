...
def test_probability_evolution():
    ...
    print("\n✓ Evolution probability test passed!")
...
def main():
    ...
    print("  ✓ GTR substitution model (most general reversible model)")
    print("  ✓ Matrix exponential for P(t)")
    print("  ✓ BioNJ for initial tree topology")
    print("  ✓ Pure Python (works on Windows!)")
